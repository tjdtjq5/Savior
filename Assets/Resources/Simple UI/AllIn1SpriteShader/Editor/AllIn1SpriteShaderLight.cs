...
public class AllIn1SpriteShaderLight : ShaderGUI
{
    Material targetMat;
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        //Not needed since Unity batches sprites with same material and textures on its own
        ...
        EditorGUILayout.Separator();
        GUILayout.Label("___Sprite Lighting___", EditorStyles.boldLabel);
        materialEditor.ShaderProperty(properties[129], properties[129].displayName);
        materialEditor.ShaderProperty(properties[130], properties[130].displayName);
        materialEditor.ShaderProperty(properties[131], properties[131].displayName);
        materialEditor.ShaderProperty(properties[132], properties[132].displayName);
    ...
    private void Billboard(MaterialEditor materialEditor, MaterialProperty[] properties, GUIStyle style, bool toggle, string inspector, string flag)
    {
        ...
        if (toggle)
        {
            ...
            EditorGUILayout.BeginVertical(style);
            {
                ...
                materialEditor.ShaderProperty(properties[133], properties[133].displayName);
    ...
    private void ZWrite(MaterialEditor materialEditor, MaterialProperty[] properties, GUIStyle style, string inspector)
    {
        ...
        if (toggle)
        {
            EditorGUILayout.BeginVertical(style);
            {
                ...
                GUILayout.Label("*Use effect 23.Alpha Cutoff for optimum results", style);
